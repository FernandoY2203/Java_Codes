package br.com.yuji.bootcampPadroesProjetoExemplo.config;
...
public class SwaggerConfig {
	...
	private Info infoApi() {
		...
		apiInfoBuilder.title("REST API - Padrões de Projeto");
		apiInfoBuilder.description("Exemplo de Padrões de Projeto com Spring REST API");
